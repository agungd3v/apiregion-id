...
router.get("/", (req: Request, res: Response) => res.status(200).json({message: "api wilayah indonesia"}));
router.get("/api", (req: Request, res: Response) => res.status(200).json({message: "api wilayah indonesia"}));
